...
interface IUniswapV3PoolEvents {
    ...
    /// @notice Emitted on liquidity mints and burns; provides detailed information about pool liquidity at each tick space of the position
    ...
    /// @param tickSpaceLowerToken1v0E18 The price of token1 in terms of token0 at the lower bound of the tick space, scaled by 1e18
    /// @param tickSpaceUpperToken1v0E18 The price of token1 in terms of token0 at the upper bound of the tick space, scaled by 1e18
    ...
    /// @param token0BalanceAtTickSpace The total balance of token0 in the pool corresponding to the liquidity at this tick space
    /// @param token1BalanceAtTickSpace The total balance of token1 in the pool corresponding to the liquidity at this tick space
    /// @param poolInfo Struct containing basic information about the pool (token addresses, fee tier, etc.)
    /// @param positionId The unique identifier for the position, generated from keccak256 hash of owner, tickLower, and tickUpper
    event PoolLiquidityAtTickSpace(
        int24 tickSpaceLower,
        uint256 tickSpaceLowerToken1v0E18,
        uint256 tickSpaceUpperToken1v0E18,
        uint128 poolLiquidityAtTickSpace,
        int128 liquidityNet,
        uint256 token0BalanceAtTickSpace,
        uint256 token1BalanceAtTickSpace,
        PoolInfo poolInfo,
        bytes32 positionId
    );
